...
<head>
  ...
  <style>
    ...
    .car-modal-close:hover { background: rgba(255,255,255,0.2); color: #fff; }
    ...
    .car-modal-header h3 { margin: 0 0 4px; font-size: 1.35rem; font-weight: 800; }
    .modal-badge {
      font-size: 0.68rem;
    ...
    .car-modal-section { margin-bottom: 1.25rem; }
    .car-modal-section h4 {
      font-size: 0.68rem;
      text-transform: uppercase;
    ...
    .modal-value { font-size: 0.88rem; font-weight: 600; color: #fff; word-break: break-word; }

    .modal-fare-rows { display: flex; flex-direction: column; gap: 0.4rem; }
    .modal-fare-row {
      display: flex;
    ...
    .modal-fare-row span:last-child { font-weight: 700; color: #fff; white-space: nowrap; }
    .modal-fare-total {
    ...
    .modal-fare-total span:last-child { color: #ffc107 !important; font-size: 1.05rem; }
    ...
    .modal-status[hidden] { display: none !important; }
    .modal-status-success { background: rgba(34,197,94,0.12); border: 1px solid rgba(34,197,94,0.3); color: #4ade80; }
    .modal-status-error   { background: rgba(239,68,68,0.12);  border: 1px solid rgba(239,68,68,0.3);  color: #f87171; }

    .modal-actions { display: flex; flex-direction: column; gap: 0.65rem; margin-top: 1.25rem; }
    .modal-confirm-btn { width: 100%; text-align: center; justify-content: center; }
    .modal-whatsapp-btn {
      width: 100%;
      text-align: center;
      justify-content: center;
    ...
    .modal-whatsapp-btn:hover { background: rgba(37,211,102,0.22) !important; color: #fff !important; }
    .modal-whatsapp-btn[hidden] { display: none !important; }

    /* Select button on estimate cards */
    .estimate-select-btn {
      display: block;
      width: 100%;
      margin-top: 0.75rem;
    ...
    .estimate-select-btn:hover { background: rgba(255,193,7,0.22); color: #fff; border-color: rgba(255,193,7,0.6); }
  </style>
</head>
<body>
  <header class="topbar">
    <div class="container">
      <div class="nav-shell">
        ...
        <div class="nav-cta">
          <div class="support">
            <span><small>24/7 Support</small>+91 12345 67890</span>
          </div>
          ...
          <div class="hero-left">
            ...
            <div class="hero-benefits">
              <div class="benefit">
                ...
                <div><strong>Safe &amp; Secure</strong><span>Your safety is our top priority on every route.</span></div>
              </div>
              <div class="benefit">
                <div class="icon-badge">V</div>
                <div><strong>Verified Drivers</strong><span>Professional, courteous and background-checked.</span></div>
              </div>
              <div class="benefit">
                <div class="icon-badge">P</div>
                <div><strong>Transparent Pricing</strong><span>No hidden charges. What you see is what you pay.</span></div>
              </div>
            </div>
          </div>

          <aside class="booking-card glass" id="booking">
            <!-- BUG FIX: was 'is_hidden' (underscore) → now 'is-hidden' (hyphen) -->
    ...
    <section class="stats">
      <div class="container">
        <div class="stats-shell glass">
          <div class="stat"><div class="stat-icon">25</div><div><strong>25K+</strong><span>Happy Customers</span></div></div>
          <div class="stat"><div class="stat-icon">15</div><div><strong>15K+</strong><span>Rides Completed</span></div></div>
          <div class="stat"><div class="stat-icon">50</div><div><strong>50+</strong><span>Cities Covered</span></div></div>
          <div class="stat"><div class="stat-icon">4.9</div><div><strong>4.9</strong><span>Customer Rating</span></div></div>
          <div class="stat"><div class="stat-icon">24</div><div><strong>24/7</strong><span>Customer Support</span></div></div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="services-grid">
          <article class="service-card">
            <div class="service-body"><div class="icon-badge"><span class="icon-badge-plane" aria-hidden="true">&#9992;</span></div><h3>Airport Transfers</h3><p>On-time airport pickup and drop with live coordination for arrivals and departures.</p></div>
            <div class="service-image"><img src="https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=900&q=80" alt="Airport transfer service"><div class="service-arrow">&rarr;</div></div>
          </article>
          <article class="service-card">
            <div class="service-body"><div class="icon-badge"><img class="icon-badge-image" src="images/service-city.svg" alt="City Rides icon"></div><h3>City Rides</h3><p>Quick and comfortable rides within the city for daily travel, meetings and events.</p></div>
            <div class="service-image"><img src="https://images.unsplash.com/photo-1514565131-fce0801e5785?auto=format&fit=crop&w=900&q=80" alt="City rides service"><div class="service-arrow">&rarr;</div></div>
          </article>
          <article class="service-card">
            <div class="service-body"><div class="icon-badge"><img class="icon-badge-image" src="images/service-outstation.svg" alt="Outstation icon"></div><h3>Outstation</h3><p>Safe long-distance travel with premium sedans and professional chauffeurs.</p></div>
            <div class="service-image"><img src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80" alt="Outstation service"><div class="service-arrow">&rarr;</div></div>
          </article>
          <article class="service-card">
            <div class="service-body"><div class="icon-badge"><img class="icon-badge-image" src="images/service-hourly.svg" alt="Hourly Rentals icon"></div><h3>Hourly Rentals</h3><p>Book by the hour for shopping, business travel or flexible day plans.</p></div>
            <div class="service-image"><img src="https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=900&q=80" alt="Hourly rental service"><div class="service-arrow">&rarr;</div></div>
          </article>
          <article class="service-card">
            <div class="service-body"><div class="icon-badge"><img class="icon-badge-image" src="images/service-corporate.svg" alt="Corporate Travel icon"></div><h3>Corporate Travel</h3><p>Premium business transport solutions with polished service and account support.</p></div>
            <div class="service-image"><img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=900&q=80" alt="Corporate travel service"><div class="service-arrow">&rarr;</div></div>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="fleet-grid">
          <article class="fleet-card glass">
            <div class="icon-badge">S</div><h3>Executive Sedan</h3>
            <p>Ideal for premium city travel with refined interiors, quiet comfort and professional chauffeur service.</p>
            <div class="fleet-meta"><span class="chip">3 Passengers</span><span class="chip">2 Bags</span><span class="chip">Wi-Fi</span></div>
            <img src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=900&q=80" alt="Executive sedan">
          </article>
          <article class="fleet-card glass">
            <div class="icon-badge">U</div><h3>Luxury SUV</h3>
            <p>Spacious and dependable for family trips, airport transfers and long-distance comfort.</p>
            <div class="fleet-meta"><span class="chip">6 Passengers</span><span class="chip">4 Bags</span><span class="chip">AC Cabin</span></div>
            <img src="images/xylo-img.png" alt="Luxury SUV">
          </article>
          <article class="fleet-card glass">
            <div class="icon-badge">B</div><h3>Business Class</h3>
            <p>Designed for corporate travel with premium finish, punctual scheduling and elevated service quality.</p>
            <div class="fleet-meta"><span class="chip">4 Passengers</span><span class="chip">Meet &amp; Greet</span><span class="chip">Priority Support</span></div>
      ...
      <div class="container">
        ...
        <div class="pricing-grid">
          <article class="price-card">
            <div class="icon-badge">1</div><h3>City Starter</h3>
            <p class="price">$18 <small>/ ride</small></p>
            <ul class="price-list"><li>Up to 8 km included</li><li>Ideal for short city trips</li><li>Instant booking support</li></ul>
            <a class="button button-secondary" href="#booking">Choose Plan</a>
          </article>
          <article class="price-card featured">
            <div class="icon-badge">2</div><h3>Premium Comfort</h3>
            <p class="price">$42 <small>/ ride</small></p>
            <ul class="price-list"><li>Executive sedan access</li><li>Airport and business travel</li><li>Priority pickup scheduling</li></ul>
            <a class="button button-primary" href="#booking">Book Premium</a>
          </article>
          <article class="price-card">
            <div class="icon-badge">3</div><h3>Hourly Flex</h3>
            <p class="price">$65 <small>/ 3 hrs</small></p>
            <ul class="price-list"><li>Multiple stops included</li><li>Best for meetings and events</li><li>Dedicated driver standby</li></ul>
      ...
      <div class="container">
        <div class="app-card glass">
          ...
          <div class="app-points">
            <div class="point"><div class="square-icon">RT</div><div><strong>Real-time Tracking</strong><span>Track your driver live from dispatch to drop-off.</span></div></div>
            <div class="point"><div class="square-icon">EP</div><div><strong>Easy Payments</strong><span>Choose from secure digital or card payment methods.</span></div></div>
            <div class="point"><div class="square-icon">EO</div><div><strong>Exclusive Offers</strong><span>Unlock app-only discounts and repeat rider rewards.</span></div></div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="testimonials">
          <article class="testimonial glass">
            ...
            <div><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p>Excellent service. Driver was on time, very professional and the ride was extremely comfortable.</p><strong>Rahul Sharma</strong></div>
          </article>
          <article class="testimonial glass">
            <img class="avatar" src="images/avatar-priya.svg" alt="Priya Mehta">
            <div><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p>I always prefer White Call Taxi for airport transfers. Always reliable and safe.</p><strong>Priya Mehta</strong></div>
          </article>
          <article class="testimonial glass">
            <img class="avatar" src="images/avatar-amit.svg" alt="Amit Verma">
            <div><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p>Best cab service in the city. Clean cars, polite drivers and fair pricing every time.</p><strong>Amit Verma</strong></div>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="footer-shell glass">
        <div class="footer-brand">
          <a class="brand footer-brand-row" href="#home" aria-label="White Call Taxi">
            ...
            <div class="brand-copy footer-copy"><strong>WHITE CALL TAXI</strong><span>Premium Taxi Service</span></div>
          </a>
          <p class="footer-text">We provide premium taxi services with comfort, safety and reliability.</p>
          <div class="socials"><a href="#">Fb</a><a href="#">X</a><a href="#">Ig</a><a href="#">In</a></div>
        </div>
        <div class="footer-col">
          <h4>Quick Links</h4>
          <nav><a href="#home">Home</a><a href="#about">About Us</a><a href="#fleet">Our Fleet</a><a href="#services">Services</a><a href="#pricing">Pricing</a><a href="#contact">Contact Us</a></nav>
        </div>
        <div class="footer-col">
          <h4>Our Services</h4>
          <nav><a href="#services">Airport Transfers</a><a href="#services">City Rides</a><a href="#services">Outstation</a><a href="#services">Hourly Rentals</a><a href="#services">Corporate Travel</a></nav>
        </div>
        <div class="footer-col">
          <h4>Contact Us</h4>
          <nav>
  ...
  <!-- ═══════════════════════════════════════════════════
       CAR DETAIL MODAL — lives here so DOM is ready
       ═══════════════════════════════════════════════════ -->
  <div id="car-detail-modal" class="car-modal-overlay" aria-modal="true" role="dialog" aria-label="Booking Summary" hidden>
    <div class="car-modal-card glass">
      <button class="car-modal-close" id="car-modal-close" type="button" aria-label="Close">&times;</button>
      ...
      <div class="car-modal-section">
        ...
        <div class="modal-grid">
          ...
          <div class="modal-item modal-item-full"><span class="modal-label">Email</span><span class="modal-value" id="modal-email">-</span></div>
        </div>
      </div>
      ...
      <div class="car-modal-section">
        ...
        <div class="modal-fare-rows">
          ...
          <div class="modal-fare-row">
            <span>Distance Charge (<span id="modal-dist-label">-</span> km &times; Rs.<span id="modal-per-km">-</span>)</span>
            <span id="modal-dist-charge">-</span>
          </div>
          <div class="modal-fare-row" id="modal-allowance-row" hidden>
            <span>Driver Allowance</span>
            <span id="modal-driver-allowance">-</span>
          </div>
          <div class="modal-fare-row modal-fare-total">
            <span>Total Estimated Fare</span>
            <span id="modal-total-fare">-</span>
          </div>
        </div>
      </div>

      <p class="modal-status modal-status-success" id="modal-success-msg" hidden>
        ✅ Confirmation sent to your email! Opening WhatsApp…
      </p>
      <p class="modal-status modal-status-error" id="modal-error-msg" hidden></p>

      <div class="modal-actions">
        <button class="button button-primary modal-confirm-btn" id="modal-confirm-btn" type="button">
          <span id="modal-confirm-label">Confirm &amp; Send Booking &rarr;</span>
          <span id="modal-confirm-spinner" hidden>Sending…</span>
        </button>
        <button class="modal-whatsapp-btn" id="modal-whatsapp-btn" type="button" hidden>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="margin-right:8px;flex-shrink:0"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.555 4.122 1.527 5.854L.057 23.5l5.797-1.52A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.793 9.793 0 01-5.017-1.38l-.36-.214-3.44.902.918-3.354-.235-.375A9.795 9.795 0 012.182 12C2.182 6.57 6.57 2.182 12 2.182S21.818 6.57 21.818 12 17.43 21.818 12 21.818z"/></svg>
          Open WhatsApp
        </button>
      </div>
    </div>
  ...
  <script>
    ...
    if (bookingForm) {
      ...
      const showForm = () => { formContainer?.classList.remove('is-hidden'); resultsWrapper?.classList.add('is-hidden'); };
      ...
      const renderEstimationResults = (results, distanceKm, tripType, tripDays) => {
        ...
        results.forEach((item) => {
          ...
          card.innerHTML = `
            ...
            <button class="estimate-select-btn" type="button">Select This Car &rarr;</button>
          `;

          card.querySelector('.estimate-select-btn').addEventListener('click', () => {
            // Build payload for email + WhatsApp
            ...
            document.getElementById('modal-trip-type').textContent =
              tripType === 'two-way'
                ? `Round Trip (${tripDays} day${tripDays > 1 ? 's' : ''})`
                : 'One Way';
            document.getElementById('modal-distance').textContent  = `${item.travelDistance.toFixed(1)} km`;
            document.getElementById('modal-base-fare').textContent = inr(item.baseFare);
            ...
            document.getElementById('modal-dist-charge').textContent = inr(distCharge);
            document.getElementById('modal-total-fare').textContent  = inr(item.estimatedFare);

            const allowanceRow = document.getElementById('modal-allowance-row');
            if (item.driverAllowance > 0) {
              document.getElementById('modal-driver-allowance').textContent = inr(item.driverAllowance);
      ...
      const calculateEstimates = (distanceKm) => {
        ...
        const rows = Object.entries(rateTable).map(([vehicle, r]) => {
